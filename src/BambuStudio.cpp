...
int CLI::run(int argc, char **argv)
{
    ...
    BOOST_LOG_TRIVIAL(info) << "Current MineSlice-Studio Version "<< SLIC3R_VERSION << std::endl;
...
bool CLI::setup(int argc, char **argv)
{
    ...
    if (BlacklistedLibraryCheck::get_instance().perform_check()) {
        ...
        text += L"\n\n"
                L"MineSlice-Studio is known to not run correctly with these DLLs injected. "
...
void CLI::print_help(bool include_print_options, PrinterTechnology printer_technology) const
{
    boost::nowide::cout
        ...
        << std::endl
        << "Usage: mineslicestudio [ OPTIONS ] [ file.3mf/file.stl ... ]" << std::endl
        << std::endl
        << "OPTIONS:" << std::endl;
